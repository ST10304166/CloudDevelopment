...
namespace CloudDevelopment.Models
{
    public class ProductDisplayModel
    {
        ...
        public static List<ProductDisplayModel> SelectProducts()
        {
            ...
            string con_string = "Server=tcp:stevenb.database.windows.net,1433;Initial Catalog=stevenb;Persist Security Info=False;User ID=Steven;Password=Eastarmy97;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30";
